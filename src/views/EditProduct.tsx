...
export async function action({request, params} : ActionFunctionArgs) {
  ...
  if(params.id !== undefined){
    //Una vez pasada la validacion llamamos a la funcion
  ...
  return (
    <>
      <div className="flex justify-between">
          ...
          <Link
            to="/"
            className="rounded-md bg-indigo-600 p-3 text-sm font-bold text-white shadow-sm hover:bg-indigo-500 cursor-pointer"
          >
              Volver a Productos
          </Link>
      </div>
